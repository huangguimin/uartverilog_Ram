## Generated SDC file "my_uart_top.out.sdc"
...
create_clock -name {clk_int} -period 40.000 -waveform { 0.000 20.000 } [get_ports {clk_int}]
...
create_generated_clock -name {PLL|altpll_component|auto_generated|pll1|clk[0]} -source [get_pins {PLL|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50.000 -multiply_by 10 -master_clock {clk_int} [get_pins {PLL|altpll_component|auto_generated|pll1|clk[0]}] 
